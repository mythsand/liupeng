...
<section class="content">
	<section class="widget" style="min-height:300px">
		...
		<div class="content">
			<form action="/admin/admin-team-add" method="post">
				<div class="field-wrap">
					<label class="label">队伍编号</label>
					<input type="text" name="teamNo">
				</div>
				<div class="field-wrap">
					<label class="label">组长编号</label>
					<input type="text" name="LeaderNo"/>
				</div>
				<div class="field-wrap">
					<label class="label">指导老师编号</label>
					<input type="text" name="teaNo"/>
				</div>
				<div class="field-wrap">
					<label class="label">成员编号</label>
